...
from sam2rad.models.sam2.modeling.sam2_utils import (
    get_1d_sine_pe,
...
class Model(BaseModel):
    def __init__(
        ...
        self.obj_ptr_tpos_proj = obj_ptr_tpos_proj
    ...
    def freeze_pretrained_parameters(self):
        self.maskmem_tpos_enc.requires_grad = False
        self.no_mem_embed.requires_grad = False
        self.no_mem_pos_enc.requires_grad = False
        self.no_obj_ptr.requires_grad = False
        for param in self.mask_downsample.parameters():
            param.requires_grad = False

    def forward(self, batch, learnable_prompts, inference=False):
        """
        Parameters:
        - learned_prompts: Tensor of shape (batch size|num_classes|batch size*num_classes, num_prompts, 256).
        ...
        return {
            ...
            "pred_boxes": pred_boxes,  # (B, 2, 256)
            # "box_embeddings": box_embeddings,  # (B,  2, 256)
        }
